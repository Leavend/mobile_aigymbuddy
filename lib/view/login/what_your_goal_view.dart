...
class _WhatYourGoalViewState extends State<WhatYourGoalView> {
  ...
  void _onConfirm() {
    ...
    widget.signUpData
      ..goal = selected.mappedGoal
      ..level = widget.signUpData.level ?? 'beginner'
      ..location = widget.signUpData.location ?? selected.defaultLocation;

    // Di tahap ini kamu bisa commit ke DB menggunakan AuthRepository.register(signUpData)
    // Untuk sekarang, navigasi ke Welcome.
...
class _GoalCardData {
  ...
  // mapping internal
  final String mappedGoal;      // 'fat_loss' | 'muscle_gain' | 'maintain'
  final String defaultLocation; // 'home' | 'gym'
}
